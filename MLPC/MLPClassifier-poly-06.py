...
kernel_pca = KernelPCA(
    n_components=5,          # reduce dimensionality
    kernel="poly",
    degree=3,
    gamma=None,              # let sklearn choose 1/n_features
    coef0=1,
    fit_inverse_transform=False   # VERY IMPORTANT
)
...
classifier = MLPClassifier(hidden_layer_sizes=(13, 13, 13), max_iter=1000, random_state=42)
